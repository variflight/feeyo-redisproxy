...
public class HttpEncoder implements Encoder<HttpMsgRequest>{
	
	private static Logger LOGGER = LoggerFactory.getLogger(HttpEncoder.class);
	
	
	@Override
	public ByteBuffer encode(HttpMsgRequest req) {
