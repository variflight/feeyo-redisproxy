...
public class BigKeyDelegation implements Comparator<String> {
	...
	public synchronized BigKey put(ConcurrentHashMap<String, BigKey> map, BigKey bigkey) {
	 ...
	 * src为最新数据，合并进dest
	 */
	public synchronized ConcurrentHashMap<String, BigKey> putAll(
	...
	public void storeBigkey2Mem(String cmd, String keyStr, int requestSize, int responseSize) {
	...
	public void storeUnusedBigkey2File() {
	...
	public void saveFile(String date ,boolean isTemp) {
