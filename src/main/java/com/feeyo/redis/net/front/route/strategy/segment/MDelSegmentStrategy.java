...
public class MDelSegmentStrategy extends SegmentStrategy {

	@Override
	public RedisRequestType unpack(RedisRequest request,  List<RedisRequest> newRequests,  List<Segment> segments) 
