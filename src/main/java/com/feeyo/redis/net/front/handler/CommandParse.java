...
public class CommandParse {
	...
	public static final byte COMMON_CMD 		= 2;		// 普通指令
	public static final byte MANAGE_CMD 		= 3;		// 管理指令
	
	// 处理策略
	public static final byte PUBSUB_CMD 		= 5;		// 
	public static final byte THROUGH_CMD 	= 6;		// 透传指令
	public static final byte BLOCK_CMD 	    = 7;		// 阻塞指令
	public static final byte AUTO_RESP_CMD	= 8;		// 中间件应答指令
	
	public static final byte MGETSET_CMD		= 9;		// mgetset
	public static final byte DEL_CMD			= 10;		// 中间件加强指令 del
	public static final byte EXISTS_CMD		= 11;	// 中间件加强指令 exists
	...
	static {		
		// Manage
		_cmds.put("SHOW", 			new RedisRequestPolicy(MANAGE_CMD, AUTO_RESP_CMD, READ_CMD));
		_cmds.put("RELOAD", 			new RedisRequestPolicy(MANAGE_CMD, AUTO_RESP_CMD, WRITE_CMD));
		_cmds.put("JVM", 			new RedisRequestPolicy(MANAGE_CMD, AUTO_RESP_CMD, READ_CMD));
		_cmds.put("ZK", 				new RedisRequestPolicy(MANAGE_CMD, AUTO_RESP_CMD, WRITE_CMD));
		_cmds.put("NODE", 			new RedisRequestPolicy(MANAGE_CMD, AUTO_RESP_CMD, WRITE_CMD));
		_cmds.put("USE", 			new RedisRequestPolicy(MANAGE_CMD, AUTO_RESP_CMD, WRITE_CMD));
		// Cluster
		_cmds.put("CLUSTER", 		new RedisRequestPolicy(MANAGE_CMD, AUTO_RESP_CMD, WRITE_CMD));
		...
		// Connection
		_cmds.put("AUTH", 				new RedisRequestPolicy(COMMON_CMD, AUTO_RESP_CMD, READ_CMD));
		_cmds.put("ECHO", 				new RedisRequestPolicy(COMMON_CMD, AUTO_RESP_CMD, READ_CMD));
		_cmds.put("PING", 				new RedisRequestPolicy(COMMON_CMD, AUTO_RESP_CMD, READ_CMD));
		_cmds.put("QUIT", 				new RedisRequestPolicy(COMMON_CMD, AUTO_RESP_CMD, READ_CMD));
		_cmds.put("SELECT", 				new RedisRequestPolicy(COMMON_CMD, AUTO_RESP_CMD, READ_CMD));
