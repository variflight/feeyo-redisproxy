...
public class CommandParse {
	...
	static {		
		...
		//Key
		_cmds.put("DEL", 			new RedisRequestPolicy(DEL_CMD, DELETE_CMD, TYPE_KEY_CMD));
		...
		_cmds.put("SCAN", 			new RedisRequestPolicy(DISABLED_CMD, READ_CMD, TYPE_KEY_CMD));
		...
		//Hash
		_cmds.put("HDEL", 				new RedisRequestPolicy(THROUGH_CMD, DELETE_CMD, TYPE_HASH_CMD));
		...
		_cmds.put("LREM", 				new RedisRequestPolicy(THROUGH_CMD, DELETE_CMD, TYPE_LIST_CMD));
		_cmds.put("LSET", 				new RedisRequestPolicy(THROUGH_CMD, WRITE_CMD, TYPE_LIST_CMD));
		_cmds.put("LTRIM", 				new RedisRequestPolicy(THROUGH_CMD, DELETE_CMD, TYPE_LIST_CMD));
		...
		_cmds.put("SMOVE", 				new RedisRequestPolicy(THROUGH_CMD, DELETE_CMD, TYPE_SET_CMD));
		_cmds.put("SPOP", 				new RedisRequestPolicy(THROUGH_CMD, DELETE_CMD, TYPE_SET_CMD));
		_cmds.put("SRANDMEMBER", 		new RedisRequestPolicy(THROUGH_CMD, READ_CMD, TYPE_SET_CMD));
		_cmds.put("SREM", 				new RedisRequestPolicy(THROUGH_CMD, DELETE_CMD, TYPE_SET_CMD));
		...
		_cmds.put("ZREM", 				new RedisRequestPolicy(THROUGH_CMD, DELETE_CMD, TYPE_SORTEDSET_CMD));
		_cmds.put("ZREMRANGEBYRANK",	new RedisRequestPolicy(THROUGH_CMD, DELETE_CMD, TYPE_SORTEDSET_CMD));
		_cmds.put("ZREMRANGEBYSCORE", 	new RedisRequestPolicy(THROUGH_CMD, DELETE_CMD, TYPE_SORTEDSET_CMD));
		...
		_cmds.put("ZSCAN", 				new RedisRequestPolicy(THROUGH_CMD, READ_CMD, TYPE_SORTEDSET_CMD));
