...
public final class ClusterCRC16Util {
	...
	public static int getSlot(String key, boolean isHashTag) {	
		...
		// 哈希槽：将不同的key平均分布到N个虚拟节点中
		// 算法：slot = getCRC16(key) % N，等价于 getCRC16(key) & (N-1)
	 ...
	 * 
	 * @param bytes
	 * @return CRC16 as integer value See <a href="https://github.com/xetorthio/jedis/pull/733#issuecomment-55840331">Issue 733</a>
	 */
