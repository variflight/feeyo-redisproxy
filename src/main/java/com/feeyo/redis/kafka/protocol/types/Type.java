 ...
 */
package com.feeyo.redis.kafka.protocol.types;
...
public abstract class Type {
    ...
    public static final Type RECORDS = new Type() {
        ...
        public void write(ByteBuffer buffer, Object o) {
            ...
            NULLABLE_BYTES.write(buffer, record.get());
        }
        ...
        @Override
        public Record validate(Object item) {
            if (item == null)
                return null;
            ...
            throw new SchemaException(item + " is not an instance of " + Record.class.getName());
        }
    };
